...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-exim-green selection:text-white">
      ...
      <section className="relative bg-[#f2f6fa] overflow-hidden">
        ...
        <div className="block lg:hidden">
          {/* Text content first */}
          <div className="px-6 py-8 flex flex-col bg-gradient-to-b from-[#eef4fa] to-white">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-6">
              <a href="#download" className="flex items-center gap-2 bg-exim-navy hover:bg-exim-navy-dark text-white text-xs font-bold py-2.5 px-4.5 rounded-full shadow-md transition-all hover:scale-105 duration-200">
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-white hover:bg-gray-50 text-exim-navy border-2 border-exim-navy/20 text-xs font-bold py-2 px-4 rounded-full shadow-sm transition-all hover:scale-105 duration-200"
              >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center z-10">
            <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-12">
              <div className="col-span-5 xl:col-span-4 flex flex-col justify-center">
                ...
                <div className="flex items-center gap-3 mt-6">
                  <a href="#download" className="flex items-center gap-2 bg-exim-navy hover:bg-exim-navy-dark text-white text-[11px] lg:text-xs font-bold py-3 px-5 rounded-full shadow-md transition-all hover:scale-105 duration-200">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
                    <span>Download Now</span>
                  ...
                  <button 
                    onClick={() => alert("Watch Video feature is coming soon!")}
                    className="flex items-center gap-2 bg-white hover:bg-gray-50 text-exim-navy border-2 border-exim-navy/20 text-[11px] lg:text-xs font-bold py-2.5 px-5 rounded-full shadow-sm transition-all hover:scale-105 duration-200"
                  >
                    <svg className="w-4 h-4 text-exim-blue fill-exim-blue" viewBox="0 0 24 24">
                      <path d="M8 5v14l11-7z" />
                    </svg>
      ...
      {/* WHO CAN USE THIS PLATFORM SECTION */}
      <section id="about" className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 max-w-6xl mx-auto">
            {/* Exporters Card */}
            <div className="group relative rounded-3xl bg-[#f3f9f6] border border-green-50/50 p-6 text-center flex flex-col justify-between shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="group relative rounded-3xl bg-[#f0f5fa] border border-blue-50/50 p-6 text-center flex flex-col justify-between shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="flex flex-col items-center">
            ...
            {/* Buyers Card */}
            <div className="group relative rounded-3xl bg-[#fdf8f4] border border-orange-50/50 p-6 text-center flex flex-col justify-between shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              <div className="flex flex-col items-center">
      ...
      {/* COMPRESSED POWERFUL FEATURES SECTION */}
      <section id="features" className="py-12 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-exim-navy">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-3xl border border-gray-200/60 p-5 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow duration-300">
              <div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mt-10 max-w-5xl mx-auto">
            {/* Step 1 */}
            <div className="flex flex-col items-center text-center max-w-[200px] relative z-10 group">
              <div className="w-16 h-16 rounded-full border-4 border-exim-green bg-white flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
            ...
            {/* Arrow 1 to 2 */}
            <div className="hidden md:flex items-center justify-center flex-1 h-16 relative">
              <svg className="w-6 h-6 text-gray-300 absolute top-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            {/* Step 2 */}
            <div className="flex flex-col items-center text-center max-w-[200px] relative z-10 group">
              <div className="w-16 h-16 rounded-full border-4 border-exim-blue bg-white flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
            ...
            {/* Step 3 */}
            <div className="flex flex-col items-center text-center max-w-[200px] relative z-10 group">
              <div className="w-16 h-16 rounded-full border-4 border-exim-orange bg-white flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="bg-exim-navy rounded-[32px] overflow-hidden shadow-xl relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-6 sm:p-12 relative z-10">
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-lg border border-white/20 transform hover:scale-[1.01] transition-transform duration-300">
                ...
                <a href="/pricing" className="block w-full mt-6 py-3 px-5 rounded-2xl bg-exim-green hover:bg-[#0e7c4b] text-white text-xs font-bold transition-all shadow-md hover:shadow-lg text-center">
                  Get Started Now
                </a>
              </div>
      ...
      {/* DOWNLOAD APP SECTION - COMPRESSED */}
      <section id="download" className="py-12 bg-gray-50 border-t border-gray-100">
