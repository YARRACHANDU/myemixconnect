    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-exim-green selection:text-white">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          {/* Hands shaking image */}
          <div className="relative rounded-3xl overflow-hidden shadow-xl border border-gray-100 aspect-[4/3] group">
            <Image
              src="/hands.png"
      ...
      <section className="py-12 bg-gray-50 border-y border-gray-100">
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-10 w-full mx-auto">
            {/* Card 1 */}
            <div className="bg-white rounded-3xl border border-gray-200/60 p-4 flex flex-col items-center text-center shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
              <div className="w-12 h-12 rounded-full bg-green-50 text-exim-green flex items-center justify-center animate-pulse-subtle">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            {/* Card 2 */}
            <div className="bg-white rounded-3xl border border-gray-200/60 p-4 flex flex-col items-center text-center shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
              <div className="w-12 h-12 rounded-full bg-green-50 text-exim-green flex items-center justify-center">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  viewBox="0 0 24 24"
      ...
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-[#f0f7f3] rounded-[32px] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-stretch border border-gray-100 shadow-lg min-h-[260px]">
            {/* Left Content */}
            ...
            <div className="col-span-12 lg:col-span-7 h-56 lg:h-auto relative overflow-hidden flex">
              <div className="flex w-[124%] -ml-[12%] h-full">
                {/* Panel 1: Plane */}
                <div className="relative h-full flex-1 -skew-x-[15deg] overflow-hidden border-r-2 border-white first:ml-[-20px]">
                  <div className="absolute -inset-y-3 -inset-x-12 skew-x-[15deg]">
                    <Image
                      src="/plane.png"
                      alt="Plane Cargo"
                      fill
                ...
                {/* Panel 2: Truck */}
                <div className="relative h-full flex-1 -skew-x-[15deg] overflow-hidden border-r-2 border-white">
                  <div className="absolute -inset-y-3 -inset-x-12 skew-x-[15deg]">
                    <Image
                      src="/lorry.png"
                      alt="Truck Cargo"
                ...
                {/* Panel 4: Yard */}
                <div className="relative h-full flex-1 -skew-x-[15deg] overflow-hidden">
                  <div className="absolute -inset-y-3 -inset-x-12 skew-x-[15deg]">
                    <Image
                      src="/yarrd.png"
                      alt="Yard Cargo"
