      ...
      <section className="py-16 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-3 flex justify-center">
            <div className="relative w-[260px] h-[530px] drop-shadow-2xl">
              <Image
          ...
          <div className="lg:col-span-9 grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center">
              <div className="w-12 h-12 rounded-full bg-exim-green text-white flex items-center justify-center mb-4 shadow-md shadow-green-100">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                Create a powerful business profile and showcase your products to
            ...
            <div className="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                Add your trusted freight forwarders and build long term business
                relationships.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                Add your shipping routes and receive personalized freight rates
                from your forwarders.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                Receive competitive and personalized freight rates on your
                preferred routes.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                Connect and communicate directly with your forwarders and buyers
                anytime.
              </p>
            </div>
          </div>
