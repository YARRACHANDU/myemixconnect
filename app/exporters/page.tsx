        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-10 lg:py-16">
          <div className="w-full lg:w-[48%] flex flex-col justify-center animate-fade-in-up">
            ...
            <p className="mt-5 text-gray-600 text-sm sm:text-base font-semibold leading-relaxed max-w-xl">
              MY EXIM Connect provides exporters with the right tools, global
              exposure , reliable connections to expand their business across
              the world.
            </p>
          </div>
        </div>
        ...
        <div className="text-center max-w-3xl mx-auto px-6">
          <ScrollReveal>
            ...
            <p className="text-gray-500 mt-4 font-semibold text-sm sm:text-base leading-relaxed">
              ...
              MY EXIM Connect helps you manage your export operations in a simple,
          ...
          <div className="lg:col-span-9 grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={0} className="h-full">
              <div className="bg-white h-full border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-[0_10px_25px_rgba(19,156,94,0.12)] hover:border-exim-green/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center text-center group">
                ...
                <h3 className="font-bold text-sm text-exim-navy">
                  Showcase Your Products
                </h3>
                <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                  Create a powerful business profile and showcase your products
                  to verified global buyers.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={100} className="h-full">
              <div className="bg-white h-full border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-[0_10px_25px_rgba(19,156,94,0.12)] hover:border-exim-green/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center text-center group">
                ...
                <h3 className="font-bold text-sm text-exim-navy">
                  Add Trusted Forwarders
                </h3>
                <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                  Add your trusted freight forwarders and build long term
            ...
            <ScrollReveal delay={200} className="h-full">
              <div className="bg-white h-full border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-[0_10px_25px_rgba(19,156,94,0.12)] hover:border-exim-green/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center text-center group">
                ...
                <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                  Add your shipping routes and receive personalized freight
                  rates from your forwarders.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300} className="h-full">
              <div className="bg-white h-full border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-[0_10px_25px_rgba(19,156,94,0.12)] hover:border-exim-green/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center text-center group">
                ...
                <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                  Receive competitive and personalized freight rates from your
                  Forwarders on your preferred routes.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={400} className="h-full">
              <div className="bg-white h-full border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-[0_10px_25px_rgba(19,156,94,0.12)] hover:border-exim-green/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center text-center group">
                ...
                <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                  Search globally and explore rates published by other verified
                  forwarders.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={500} className="h-full">
              <div className="bg-white h-full border border-gray-100 rounded-[24px] p-6 shadow-sm hover:shadow-[0_10px_25px_rgba(19,156,94,0.12)] hover:border-exim-green/20 hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center text-center group">
                ...
                <p className="text-gray-500 text-xs font-semibold mt-3 leading-relaxed">
                  Connect and communicate directly with your forwarders and
                  buyers anytime.
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs sm:text-sm font-semibold mt-1.5">
                  Join thousands of exporters who trust MY EXIM Connect.
                </p>
              </div>
            </div>
