...
export default function FreightForwarders() {
  return (
    <div className="min-h-screen bg-white text-gray-800 font-open-sans selection:bg-exim-green selection:text-white">
      {/* 1. HERO SECTION WITH DIAGONAL SPLIT (RESPONSIVE) */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-[#f0f7f3] border border-gray-100 rounded-[24px] p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
            ...
            <div className="flex flex-col items-center shrink-0">
              <button className="py-3 px-8 rounded-xl bg-exim-green hover:bg-[#0e7c4b] text-white text-xs font-bold shadow-md hover:scale-102 transition-all duration-200">
                Join Now
              </button>
